 ...
 * @var \backend\models\Crypto $crypto
 */

$this->title = 'duntek admin dashboard';
// шаблон взят отсюда https://getbootstrap.com/docs/5.2/examples/features/
?>
...
<div class="container px-4 py-5" id="featured-3">
    <h2 class="pb-2 border-bottom">Общая информация</h2>
    <div class="row g-4 py-5 row-cols-1 row-cols-lg-3">
        <div class="feature col">
            ...
            <p>Зарегистрировано <?= $user->getTotal() ?> клиентов, из них активных <?= $user->getActive() ?></p>
        ...
        <div class="feature col">
            ...
            <h2>Интеграции с oauth</h2>
            <p>Oauth VK активна, с yandex в работе</p>
        </div>
        <div class="feature col">
            <div class="feature-icon d-inline-flex align-items-center justify-content-center bg-primary bg-gradient text-white fs-2 mb-3">
                <svg class="bi" width="1em" height="1em">
